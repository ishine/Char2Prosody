...
from text import pinyin_to_yinsu, _yinsus_to_sequence
...
class Tacotron2(nn.Module):
    ...
    def forward(self, inputs):
        ...
        print('CHECK select_target:', select_target)
        # print('CHECK self.pinyin_to_yinsu_dict:', self.pinyin_to_yinsu_dict)
        ...
        select_pred_to_check = torch.argmax(select_pred, 2).cpu()
        print('CHECK select_pred_to_check:', select_pred_to_check)
        ...
        yinsu_id_inputs_to_check = np.array(yinsu_id_inputs.cpu()).tolist()
        # print('CHECK yinsu_id_inputs_to_check:', yinsu_id_inputs_to_check)
        print('CHECK yinsu_id_inputs_to_check:', _yinsus_to_sequence(yinsu_id_inputs_to_check))
        ...
        yinsu_embedded_inputs = yinsu_embedded_inputs.permute(0, 2, 1)
        encoder_outputs = self.encoder(yinsu_embedded_inputs, text_lengths*4)
