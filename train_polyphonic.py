...
class G2PTransformerMask(nn.Module):
    def __init__(self, num_classes, hparams):
        ...
        self.g2ptransformer = G2PTransformer(num_classes, hparams)
...
class G2PDatasetMask(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print('CHECK self.g2pdataset.class2idx:', self.g2pdataset.class2idx)
            for output_mask_item in output_mask_toks:
                output_mask.append(self.g2pdataset.class2idx[output_mask_item])
            # print('CHECK input:', input_ids, poly_idx, label_id, output_mask, self.g2pdataset.num_classes, 'of', sent)
