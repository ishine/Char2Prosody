...
def inference(args):
    ...
    with torch.no_grad():
        for i, batch in enumerate(test_loader):
            ...
            mel_path = os.path.join(args.out_filename, 'sentence_{}_mel.npy'.format(i))
            ...
            audio_path = os.path.join(args.out_filename, 'sentence_{}.wav'.format(i))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--checkpoint', type=str, help='checkpoint path', default='./tts_cascaded_taco_struc_logits_frozen_CNN_sandhi_512_b32/checkpoint_79000')
    parser.add_argument('-o', '--out_filename', type=str, help='output filename', default='./samples_from_inference_tte_3')
